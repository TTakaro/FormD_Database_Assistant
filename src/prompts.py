...
sql_sys_prompt= """You are an agent designed to interact with a SQL database.
...
The tables available to you are: issuers, offering, recipients, relatedpersons, and signatures
"""
#CONTEXT:
